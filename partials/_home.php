                                    ...
                                    <div class="animate" data-anim-type="zoomIn">
                                        <div class="call_to_action_wrapper">
                                            ...
                                            <div class="call_center">
                                                <a href="https://www.youtube.com/watch?v=ZACc1L9oXkI" rel="prettyphoto">
                                            ...
                                            <div class="call_right">
                                                <div class="desc">
                                                    If you prefer to learn from video tutorials, please click on the icon next to and watch video "How to re-create demo page"
                                                    with step by step instructions. This is so easy!
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="column_attr ">
                                    <div class="aligncenter">
                                        <a class="button button_left button_theme button_js" href="typography.html">
                                            ...
                                            <span class="button_label">Typography</span>
                                        </a>
                                        <a class="button button_left button_js" href="boxes-infographics.html">
                                            <span class="button_icon">
                                                <i class="icon-layout"></i>
                                            </span>
                                            <span class="button_label">Boxes &amp; Infographics</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
